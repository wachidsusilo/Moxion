...
public readonly record struct Acceleration( Number Value ) : IValue<Acceleration>
{
  ...
  public static Acceleration Zero => new( Number.Zero );

  #region Operators

  public static Position operator *( Acceleration left, TimeSquared right )
  {
  ...
  public static Acceleration operator +( Acceleration left, Number right )
  {
    return new Acceleration( left.Value + right );
  }

  public static Acceleration operator +( Number left, Acceleration right )
  {
  ...
  public static Number operator /( Acceleration left, Acceleration right )
  {
    if (right.IsZero)
    {
      throw new DivideByZeroException();
